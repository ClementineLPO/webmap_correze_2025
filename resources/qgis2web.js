...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [103310.326590, 5607984.238391, 370029.472612, 5750150.434292], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([103310.326590, 5607984.238391, 370029.472612, 5750150.434292], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Enquête Hirondelles 2025 - Choix des mailles à prospecter en Corrèze</h2>';
        return titleElement;
    })(),
