...
var format_Limitedescommunes_2 = new ol.format.GeoJSON();
var features_Limitedescommunes_2 = format_Limitedescommunes_2.readFeatures(json_Limitedescommunes_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Limitedescommunes_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Limitedescommunes_2.addFeatures(features_Limitedescommunes_2);
var lyr_Limitedescommunes_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Limitedescommunes_2, 
                style: style_Limitedescommunes_2,
                popuplayertitle: 'Limite des communes',
                interactive: false,
                title: '<img src="styles/legend/Limitedescommunes_2.png" /> Limite des communes'
            });
...
lyr_GoogleSatelliteHybrid_0.setVisible(false);lyr_OSMStandard_1.setVisible(false);lyr_Limitedescommunes_2.setVisible(true);lyr_Maillesprospectesen2022etou2023etou2024_3.setVisible(true);lyr_MaillesprospecterpourlenquteHirondelles_4.setVisible(true);lyr_Autresdonnesantrieures_5.setVisible(true);lyr_Donnesdelenqute2024_6.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_OSMStandard_1,lyr_Limitedescommunes_2,lyr_Maillesprospectesen2022etou2023etou2024_3,lyr_MaillesprospecterpourlenquteHirondelles_4,lyr_Autresdonnesantrieures_5,lyr_Donnesdelenqute2024_6];
lyr_Limitedescommunes_2.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'INSEE_COM': 'INSEE_COM', 'INSEE_ARR': 'INSEE_ARR', 'INSEE_COL': 'INSEE_COL', 'INSEE_DEP': 'INSEE_DEP', 'INSEE_REG': 'INSEE_REG', 'POPULATION': 'POPULATION', 'SURFACE_HA': 'SURFACE_HA', 'DATE_CREAT': 'DATE_CREAT', 'DATE_MAJ': 'DATE_MAJ', 'DATE_APP': 'DATE_APP', 'DATE_CONF': 'DATE_CONF', 'CODE_POST': 'CODE_POST', 'NOM': 'NOM', 'CL_ARROND': 'CL_ARROND', 'CL_COLLTER': 'CL_COLLTER', 'CL_DEPART': 'CL_DEPART', 'CL_REGION': 'CL_REGION', 'CAPITALE': 'CAPITALE', 'DATE_RCT': 'DATE_RCT', 'RECENSEUR': 'RECENSEUR', 'SIREN_EPCI': 'SIREN_EPCI', 'ID_CH_LIEU': 'ID_CH_LIEU', 'ID_AUT_ADM': 'ID_AUT_ADM', 'CODE_SIREN': 'CODE_SIREN', });
...
lyr_MaillesprospecterpourlenquteHirondelles_4.set('fieldAliases', {'id': 'id', 'left': 'left', 'top': 'top', 'right': 'right', 'bottom': 'bottom', 'Identifian': 'Identifian', 'bottom_bis': 'bottom_bis', 'left_bis': 'left_bis', 'ID_new': 'Identifiant', 'CODE_POST': 'Code postal', 'NOM': 'Commune', 'NOM_2': 'Département', });
...
lyr_MaillesprospecterpourlenquteHirondelles_4.set('fieldImages', {'id': 'Hidden', 'left': 'Hidden', 'top': 'Hidden', 'right': 'Hidden', 'bottom': 'Hidden', 'Identifian': 'Hidden', 'bottom_bis': 'Hidden', 'left_bis': 'Hidden', 'ID_new': 'TextEdit', 'CODE_POST': 'TextEdit', 'NOM': 'TextEdit', 'NOM_2': 'TextEdit', });
...
lyr_Limitedescommunes_2.set('fieldLabels', {'fid': 'no label', 'ID': 'no label', 'INSEE_COM': 'no label', 'INSEE_ARR': 'no label', 'INSEE_COL': 'no label', 'INSEE_DEP': 'no label', 'INSEE_REG': 'no label', 'POPULATION': 'no label', 'SURFACE_HA': 'no label', 'DATE_CREAT': 'no label', 'DATE_MAJ': 'no label', 'DATE_APP': 'no label', 'DATE_CONF': 'no label', 'CODE_POST': 'no label', 'NOM': 'no label', 'CL_ARROND': 'no label', 'CL_COLLTER': 'no label', 'CL_DEPART': 'no label', 'CL_REGION': 'no label', 'CAPITALE': 'no label', 'DATE_RCT': 'no label', 'RECENSEUR': 'no label', 'SIREN_EPCI': 'no label', 'ID_CH_LIEU': 'no label', 'ID_AUT_ADM': 'no label', 'CODE_SIREN': 'no label', });
